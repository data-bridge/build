...
void RefComment::setActionTable()
{
  ...
  ACO[ERR_LIN_MB_REPLACE] = REF_COUNT_LIN_IS;
  ACO[ERR_LIN_MB_SYNTAX] = REF_COUNT_LIN_IS;
  ACO[ERR_LIN_AN_REPLACE] = REF_COUNT_LIN_IS;
  ACO[ERR_LIN_PC_REPLACE] = REF_COUNT_LIN_IS;
  ACO[ERR_LIN_PC_SYNTAX] = REF_COUNT_LIN_IS;
  ACO[ERR_LIN_MC_REPLACE] = REF_COUNT_SINGLE;
  ACO[ERR_LIN_MC_SYNTAX] = REF_COUNT_SINGLE;

  ACO = ActionCommentOK[REF_ACTION_INSERT_LIN];
  ACO[ERR_LIN_RS_INSERT] = REF_COUNT_HEADER;
  ACO[ERR_LIN_PN_INSERT] = REF_COUNT_HEADER;
  ACO[ERR_LIN_SV_INSERT] = REF_COUNT_SINGLE;
  ACO[ERR_LIN_MB_INSERT] = REF_COUNT_LIN_IS;
  ACO[ERR_LIN_MB_SYNTAX] = REF_COUNT_LIN_IS;
  ACO[ERR_LIN_PC_INSERT] = REF_COUNT_LIN_IS;
  ACO[ERR_LIN_MC_INSERT] = REF_COUNT_SINGLE;
  ACO[ERR_LIN_SYNTAX] = REF_COUNT_MULTI;
  ...
  ACO[ERR_LIN_NT_SYNTAX] = REF_COUNT_LIN_IS;
  ...
  ACO[ERR_LIN_MB_SYNTAX] = REF_COUNT_LIN_REPEAT;
  ACO[ERR_LIN_AN_DELETE] = REF_COUNT_LIN_REPEAT;
  ACO[ERR_LIN_PC_DELETE] = REF_COUNT_LIN_REPEAT;
  ACO[ERR_LIN_MC_DELETE] = REF_COUNT_LIN_REPEAT;
  ACO[ERR_LIN_MC_SYNTAX] = REF_COUNT_LIN_REPEAT;
  ACO[ERR_LIN_TRICK_DELETE] = REF_COUNT_LIN_REPEAT;
  ACO[ERR_LIN_SYNTAX] = REF_COUNT_LIN_REPEAT;
  ...
  ACO[ERR_RBN_N_INSERT] = REF_COUNT_SINGLE;
