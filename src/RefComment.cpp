...
static RefCountType CommentOK[ERR_SIZE];
...
void RefComment::setCommentTable()
{
  CommentOK[ERR_LIN_VG_FIRST] = REF_COUNT_HEADER;
  CommentOK[ERR_LIN_VG_LAST] = REF_COUNT_HEADER;
  CommentOK[ERR_LIN_VG_REPLACE] = REF_COUNT_HEADER;
  CommentOK[ERR_LIN_VG_SYNTAX] = REF_COUNT_HEADER;

  CommentOK[ERR_LIN_VHEADER_INSERT] = REF_COUNT_HEADER;
  CommentOK[ERR_LIN_VHEADER_SYNTAX] = REF_COUNT_HEADER;

  CommentOK[ERR_LIN_RESULTS_REPLACE] = REF_COUNT_HEADER;
  CommentOK[ERR_LIN_RESULTS_INSERT] = REF_COUNT_HEADER;
  CommentOK[ERR_LIN_RESULTS_DELETE] = REF_COUNT_HEADER;

  CommentOK[ERR_LIN_RS_REPLACE] = REF_COUNT_SINGLE;
  CommentOK[ERR_LIN_RS_INSERT] = REF_COUNT_SINGLE;
  CommentOK[ERR_LIN_RS_DELETE] = REF_COUNT_LIN_FIELDS;
  CommentOK[ERR_LIN_RS_DECL_PARD] = REF_COUNT_SINGLE;
  CommentOK[ERR_LIN_RS_DECL_OPP] = REF_COUNT_SINGLE;
  CommentOK[ERR_LIN_RS_DENOM] = REF_COUNT_SINGLE;
  CommentOK[ERR_LIN_RS_LEVEL] = REF_COUNT_SINGLE;
  CommentOK[ERR_LIN_RS_MULT] = REF_COUNT_SINGLE;
  CommentOK[ERR_LIN_RS_TRICKS] = REF_COUNT_SINGLE;
  CommentOK[ERR_LIN_RS_EMPTY] = REF_COUNT_SINGLE;
  CommentOK[ERR_LIN_RS_INCOMPLETE] = REF_COUNT_SINGLE;
  CommentOK[ERR_LIN_RS_SYNTAX] = REF_COUNT_SINGLE;

  CommentOK[ERR_LIN_PLAYERS_UNKNOWN] = REF_COUNT_HEADER;
  CommentOK[ERR_LIN_PLAYERS_WRONG] = REF_COUNT_HEADER;
  CommentOK[ERR_LIN_PLAYERS_REPLACE] = REF_COUNT_HEADER;
  CommentOK[ERR_LIN_PLAYERS_DELETE] = REF_COUNT_HEADER;

  CommentOK[ERR_LIN_PN_REPLACE] = REF_COUNT_HEADER;
  CommentOK[ERR_LIN_PN_INSERT] = REF_COUNT_HEADER;
  CommentOK[ERR_LIN_PN_DELETE] = REF_COUNT_HEADER;

  CommentOK[ERR_LIN_QX_REPLACE] = REF_COUNT_SINGLE;
  CommentOK[ERR_LIN_QX_ORDER_COCO] = REF_COUNT_HEADER;
  CommentOK[ERR_LIN_QX_ORDER_OOCC] = REF_COUNT_HEADER;
  CommentOK[ERR_LIN_QX_UNORDERED] = REF_COUNT_HEADER;

  CommentOK[ERR_LIN_MD_REPLACE] = REF_COUNT_SINGLE;
  CommentOK[ERR_LIN_MD_SYNTAX] = REF_COUNT_SINGLE;

  CommentOK[ERR_LIN_NT_SYNTAX] = REF_COUNT_SINGLE;

  CommentOK[ERR_LIN_SV_REPLACE] = REF_COUNT_SINGLE;
  CommentOK[ERR_LIN_SV_INSERT] = REF_COUNT_SINGLE;
  CommentOK[ERR_LIN_SV_DELETE] = REF_COUNT_SINGLE;
  CommentOK[ERR_LIN_SV_SYNTAX] = REF_COUNT_SINGLE;

  CommentOK[ERR_LIN_MB_TRAILING] = REF_COUNT_LIN_REPEAT;
  CommentOK[ERR_LIN_MB_REPLACE] = REF_COUNT_SINGLE;
  CommentOK[ERR_LIN_MB_INSERT] = REF_COUNT_LIN_IS;
  CommentOK[ERR_LIN_MB_DELETE] = REF_COUNT_LIN_REPEAT;
  CommentOK[ERR_LIN_MB_SYNTAX] = REF_COUNT_SINGLE;

  CommentOK[ERR_LIN_AN_REPLACE] = REF_COUNT_SINGLE;
  CommentOK[ERR_LIN_AN_DELETE] = REF_COUNT_SINGLE;

  CommentOK[ERR_LIN_PC_REPLACE] = REF_COUNT_SINGLE;
  CommentOK[ERR_LIN_PC_INSERT] = REF_COUNT_SINGLE;
  CommentOK[ERR_LIN_PC_DELETE] = REF_COUNT_LIN_REPEAT;
  CommentOK[ERR_LIN_PC_SYNTAX] = REF_COUNT_SINGLE;

  CommentOK[ERR_LIN_MC_REPLACE] = REF_COUNT_SINGLE;
  CommentOK[ERR_LIN_MC_INSERT] = REF_COUNT_SINGLE;
  CommentOK[ERR_LIN_MC_DELETE] = REF_COUNT_SINGLE;
  CommentOK[ERR_LIN_MC_SYNTAX] = REF_COUNT_SINGLE;

  CommentOK[ERR_LIN_TRICK_INSERT] = REF_COUNT_LIN_IS;
  CommentOK[ERR_LIN_TRICK_DELETE] = REF_COUNT_LIN_REPEAT;
  CommentOK[ERR_LIN_TRICK_LINE_DELETE] = REF_COUNT_HANDS;

  CommentOK[ERR_LIN_HAND_OUT_OF_RANGE] = REF_COUNT_HANDS;
  CommentOK[ERR_LIN_HAND_DUPLICATED] = REF_COUNT_HANDS;
  CommentOK[ERR_LIN_HAND_AUCTION_NONE] = REF_COUNT_HANDS;
  CommentOK[ERR_LIN_HAND_AUCTION_WRONG] = REF_COUNT_HANDS;
  CommentOK[ERR_LIN_HAND_AUCTION_LIVE] = REF_COUNT_HANDS;
  CommentOK[ERR_LIN_HAND_AUCTION_ABBR] = REF_COUNT_HANDS;
  CommentOK[ERR_LIN_HAND_CARDS_MISSING] = REF_COUNT_HANDS;
  CommentOK[ERR_LIN_HAND_CARDS_WRONG] = REF_COUNT_HANDS;
  CommentOK[ERR_LIN_HAND_PLAY_MISSING] = REF_COUNT_HANDS;
  CommentOK[ERR_LIN_HAND_PLAY_WRONG] = REF_COUNT_HANDS;
  CommentOK[ERR_LIN_HAND_DIRECTOR] = REF_COUNT_HANDS;

  CommentOK[ERR_LIN_TAG_SYNTAX] = REF_COUNT_SINGLE;
  CommentOK[ERR_LIN_SYNTAX] = REF_COUNT_HANDS;
  CommentOK[ERR_LIN_OMIT] = REF_COUNT_HANDS;


  CommentOK[ERR_PBN_SITE_REPLACE] = REF_COUNT_SINGLE;
  CommentOK[ERR_PBN_ROOM_REPLACE] = REF_COUNT_SINGLE;
  CommentOK[ERR_PBN_ROOM_INSERT] = REF_COUNT_SINGLE;
  CommentOK[ERR_PBN_PLAYER_REPLACE] = REF_COUNT_SINGLE;
  CommentOK[ERR_PBN_BOARD_REPLACE] = REF_COUNT_SINGLE;
  CommentOK[ERR_PBN_DECLARER_REPLACE] = REF_COUNT_SINGLE;
  CommentOK[ERR_PBN_RESULT_REPLACE] = REF_COUNT_SINGLE;
  CommentOK[ERR_PBN_SCORE_REPLACE] = REF_COUNT_SINGLE;
  CommentOK[ERR_PBN_SCORE_IMP_REPLACE] = REF_COUNT_SINGLE;
  CommentOK[ERR_PBN_CALL_REPLACE] = REF_COUNT_SINGLE;
  CommentOK[ERR_PBN_ALERT_REPLACE] = REF_COUNT_SINGLE;
  CommentOK[ERR_PBN_ALERT_INSERT] = REF_COUNT_SINGLE;
  CommentOK[ERR_PBN_ALERT_DELETE] = REF_COUNT_SINGLE;
  CommentOK[ERR_PBN_NOTE_REPLACE] = REF_COUNT_SINGLE;
  CommentOK[ERR_PBN_NOTE_INSERT] = REF_COUNT_SINGLE;
  CommentOK[ERR_PBN_NOTE_DELETE] = REF_COUNT_SINGLE;
  CommentOK[ERR_PBN_PLAY_REPLACE] = REF_COUNT_SINGLE;
  CommentOK[ERR_PBN_HAND_AUCTION_LIVE] = REF_COUNT_HANDS;
  CommentOK[ERR_PBN_SYNTAX] = REF_COUNT_SINGLE;
  CommentOK[ERR_PBN_OMIT] = REF_COUNT_SINGLE;


  CommentOK[ERR_RBN_L_DELETE] = REF_COUNT_SINGLE; // Not really
  CommentOK[ERR_RBN_N_REPLACE] = REF_COUNT_HEADER;
  CommentOK[ERR_RBN_N_INSERT] = REF_COUNT_HEADER;
  CommentOK[ERR_RBN_P_REPLACE] = REF_COUNT_SINGLE;
  CommentOK[ERR_RBN_R_REPLACE] = REF_COUNT_SINGLE;
  CommentOK[ERR_RBN_HAND_AUCTION_LIVE] = REF_COUNT_HANDS;

  CommentOK[ERR_RBX_L_DELETE] = REF_COUNT_HEADER;
  CommentOK[ERR_RBX_N_REPLACE] = REF_COUNT_HEADER;
  CommentOK[ERR_RBX_N_INSERT] = REF_COUNT_HEADER;
  CommentOK[ERR_RBX_P_REPLACE] = REF_COUNT_SINGLE;
  CommentOK[ERR_RBX_R_REPLACE] = REF_COUNT_SINGLE;
  CommentOK[ERR_RBX_HAND_AUCTION_LIVE] = REF_COUNT_HANDS;


  CommentOK[ERR_TXT_PLAY_REPLACE] = REF_COUNT_SINGLE;
  CommentOK[ERR_TXT_RESULT_REPLACE] = REF_COUNT_SINGLE;
  CommentOK[ERR_TXT_SCORE_REPLACE] = REF_COUNT_SINGLE;
  CommentOK[ERR_TXT_SCORE_IMP_REPLACE] = REF_COUNT_SINGLE;
  CommentOK[ERR_TXT_RUNNING_REPLACE] = REF_COUNT_SINGLE;
  CommentOK[ERR_TXT_HAND_AUCTION_LIVE] = REF_COUNT_HANDS;

  CommentOK[ERR_EML_PLAY_REPLACE] = REF_COUNT_SINGLE;
  CommentOK[ERR_EML_RESULT_REPLACE] = REF_COUNT_SINGLE;
  CommentOK[ERR_EML_SCORE_REPLACE] = REF_COUNT_SINGLE;
  CommentOK[ERR_EML_SCORE_IMP_REPLACE] = REF_COUNT_SINGLE;
  CommentOK[ERR_EML_HAND_AUCTION_LIVE] = REF_COUNT_HANDS;

  CommentOK[ERR_REC_PLAY_REPLACE] = REF_COUNT_SINGLE;
  CommentOK[ERR_REC_RESULT_REPLACE] = REF_COUNT_SINGLE;
  CommentOK[ERR_REC_SCORE_REPLACE] = REF_COUNT_SINGLE;
  CommentOK[ERR_REC_SCORE_IMP_REPLACE] = REF_COUNT_SINGLE;
  CommentOK[ERR_REC_HAND_AUCTION_LIVE] = REF_COUNT_HANDS;
}
