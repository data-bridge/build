...
const vector<RefErrorBundle> RefErrors =
{
  ...
  {ERR_LIN_VHEADER_INSERT, "ERR_LIN_HEADER_INSERT"},
  ...
  {ERR_LIN_QX_REPLACE, "ERR_LIN_QXREPLACE"},
  ...
  {ERR_LIN_HAND_AUCTION_NONE, "ERR_LIN_AUCTION_NONE"},
  {ERR_LIN_HAND_AUCTION_WRONG, "ERR_LIN_AUCTION_WRONG"},
  {ERR_LIN_HAND_AUCTION_LIVE, "ERR_LIN_AUCTION_LIVE"},
  {ERR_LIN_HAND_AUCTION_ABBR, "ERR_LIN_AUCTION_ABBR"},
  {ERR_LIN_HAND_CARDS_MISSING, "ERR_LIN_CARDS_MISSING"},
  {ERR_LIN_HAND_CARDS_WRONG, "ERR_LIN_CARDS_WRONG"},
  {ERR_LIN_HAND_PLAY_MISSING, "ERR_LIN_PLAY_MISSING"},
  {ERR_LIN_HAND_PLAY_WRONG, "ERR_LIN_PLAY_WRONG"},
  ...
  {ERR_PBN_SCORE_REPLACE, "ERR_SCORE_REPLACE"},
