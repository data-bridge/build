...
enum Label
{
  ...
  BRIDGE_FORMAT_DOUBLE_DUMMY = 24,

  BRIDGE_FORMAT_AUCTION = 25,
  BRIDGE_FORMAT_DECLARER = 26,
  BRIDGE_FORMAT_CONTRACT = 27,
  BRIDGE_FORMAT_PLAY = 28,
  BRIDGE_FORMAT_RESULT = 29,
  BRIDGE_FORMAT_SCORE = 30,
  BRIDGE_FORMAT_SCORE_IMP = 31,
  BRIDGE_FORMAT_SCORE_MP = 32,
