...
enum ValError
{
  ...
  BRIDGE_VAL_LIN_PLAY_NL = 17,
  BRIDGE_VAL_PLAY_SHORT = 18,
  BRIDGE_VAL_REC_MADE_32 = 19,
  BRIDGE_VAL_TXT_RESULT = 20,
  BRIDGE_VAL_RECORD_NUMBER = 21,

  // These are real errors.
  BRIDGE_VAL_ERROR = 22,
  BRIDGE_VAL_OUT_SHORT = 23,
  BRIDGE_VAL_REF_SHORT = 24,
  BRIDGE_VAL_VG_MC = 25,
  BRIDGE_VAL_SIZE = 26
};
