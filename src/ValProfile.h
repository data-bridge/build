...
enum ValError
{
  ...
  BRIDGE_VAL_PLAY = 12,
  BRIDGE_VAL_SCORE = 13,
  BRIDGE_VAL_NAMES_SHORT = 14,
  BRIDGE_VAL_TXT_DASHES = 15,
  BRIDGE_VAL_VG_MD = 16,
  BRIDGE_VAL_VG_CHAT = 17,

  // These are Pavlicek bugs.
  BRIDGE_VAL_TXT_ALL_PASS = 18,
  BRIDGE_VAL_LIN_PN_EMBEDDED = 19,
  BRIDGE_VAL_LIN_RH_AH = 20,
  BRIDGE_VAL_LIN_EXCLAIM = 21,
  BRIDGE_VAL_LIN_ST_MISSING = 22,
  BRIDGE_VAL_LIN_SV_MISSING = 23,
  BRIDGE_VAL_LIN_PLAY_NL = 24,
  BRIDGE_VAL_PLAY_SHORT = 25,
  BRIDGE_VAL_REC_MADE_32 = 26,
  BRIDGE_VAL_TXT_RESULT = 27,
  BRIDGE_VAL_RECORD_NUMBER = 28,

  // These are real errors.
  BRIDGE_VAL_ERROR = 29,
  BRIDGE_VAL_OUT_SHORT = 30,
  BRIDGE_VAL_REF_SHORT = 31,
  BRIDGE_VAL_VG_MC = 32,
  BRIDGE_VAL_SIZE = 33
};
