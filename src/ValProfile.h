...
enum ValError
{
  ...
  BRIDGE_VAL_PLAY = 12,
  BRIDGE_VAL_NAMES_SHORT = 13,
  BRIDGE_VAL_TXT_DASHES = 14,
  BRIDGE_VAL_VG_MD = 15,
  BRIDGE_VAL_VG_CHAT = 16,

  // These are Pavlicek bugs.
  BRIDGE_VAL_TXT_ALL_PASS = 17,
  BRIDGE_VAL_LIN_PN_EMBEDDED = 18,
  BRIDGE_VAL_LIN_RH_AH = 19,
  BRIDGE_VAL_LIN_EXCLAIM = 20,
  BRIDGE_VAL_LIN_ST_MISSING = 21,
  BRIDGE_VAL_LIN_SV_MISSING = 22,
  BRIDGE_VAL_LIN_PLAY_NL = 23,
  BRIDGE_VAL_PLAY_SHORT = 24,
  BRIDGE_VAL_REC_MADE_32 = 25,
  BRIDGE_VAL_TXT_RESULT = 26,
  BRIDGE_VAL_RECORD_NUMBER = 27,

  // These are real errors.
  BRIDGE_VAL_ERROR = 28,
  BRIDGE_VAL_OUT_SHORT = 29,
  BRIDGE_VAL_REF_SHORT = 30,
  BRIDGE_VAL_VG_MC = 31,
  BRIDGE_VAL_SIZE = 32
};
