...
enum ValError
{
  ...
  BRIDGE_VAL_LIN_PN_EXTRA = 26,
  BRIDGE_VAL_LIN_PN_MISSING = 27,
  BRIDGE_VAL_LIN_PN_ROTATED = 28,
  BRIDGE_VAL_LIN_RH_EXTRA = 29,
  BRIDGE_VAL_LIN_ST_EXTRA = 30,
  BRIDGE_VAL_LIN_ST_MISSING = 31,
  BRIDGE_VAL_LIN_SV_MISSING = 32,

  BRIDGE_VAL_LIN_PLAY_NL = 33,
  BRIDGE_VAL_PLAY_SHORT = 34,
  BRIDGE_VAL_REC_MADE_32 = 35,
  BRIDGE_VAL_TXT_RESULT = 36,
  BRIDGE_VAL_RECORD_NUMBER = 37,

  // These are real errors.
  BRIDGE_VAL_ERROR = 38,
  BRIDGE_VAL_OUT_SHORT = 39,
  BRIDGE_VAL_REF_SHORT = 40,
  BRIDGE_VAL_VG_MC = 41,
  BRIDGE_VAL_SIZE = 42
};
