...
enum ValError
{
  ...
  BRIDGE_VAL_LIN_PLAY_NL = 16,
  BRIDGE_VAL_PLAY_SHORT = 17,
  BRIDGE_VAL_REC_MADE_32 = 18,
  BRIDGE_VAL_TXT_RESULT = 19,
  BRIDGE_VAL_RECORD_NUMBER = 20,

  // These are real errors.
  BRIDGE_VAL_ERROR = 21,
  BRIDGE_VAL_OUT_SHORT = 22,
  BRIDGE_VAL_REF_SHORT = 23,
  BRIDGE_VAL_VG_MC = 24,
  BRIDGE_VAL_SIZE = 25
};
